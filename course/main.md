...
**Результат**
```
Умеет пользоваться терминалом, может настроить рабочее окружение для написание проекта
...
Умеет давать парвильные имена пременным и классам
...
Понимает как работают модификаторы доступа, какие функции можно использвоать и переопределять и зачем вообще это
может понадобиться
Может создавать классы, понимает как передаются значения переменных в методы
Может реализвоать интерфейс
```
...
Читат и пониманет все конструкции
...
**Результат**
```
Понимает для чего нужен git и системы конторля версий. Чем крут гит
